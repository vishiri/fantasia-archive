...
SQLite per project; schema **`user_version` max 5** — [docs/database/projectDB.md](docs/database/projectDB.md). Template custom fields design: [templateCustomFields.md](docs/database/templateCustomFields.md).
