...
/** Per-locale document template plural title strings keyed by interface language code. */
export type I_faProjectDocumentTemplateTitleTranslations = I_faLocaleStringTranslations

/** Alias for plural document template title translations. */
export type I_faProjectDocumentTemplateTitlePluralTranslations =
