...
/**
 * E2E-only: skip native open dialog for the next load-project flow.
 */
...
export function takeNextE2eProjectOpenPath (): string | null {
  if (!isE2E()) {
    return null
  }
...
export function installFaProjectManagementE2ePathOverrideGlobals (): void {
  ...
  const g = globalThis as typeof globalThis & {
    ...
    [FA_E2E_GLOBAL_SET_NEXT_PROJECT_OPEN_PATH]?: (p: string) => void
  }
