 ...
 */
export const FA_E2E_GLOBAL_SET_NEXT_EXPORT_PATH = '__faE2eSetNextAppConfigExportPath' as const
export const FA_E2E_GLOBAL_SET_NEXT_IMPORT_PATH = '__faE2eSetNextAppConfigImportPath' as const
 ...
 */
export function takeNextE2eAppConfigExportPath (): string | null {
  if (!isE2E()) {
    return null
  }
 ...
 */
export function takeNextE2eAppConfigImportPath (): string | null {
  if (!isE2E()) {
    return null
  }
 ...
 */
export function installFaAppConfigE2ePathOverrideGlobals (): void {
  if (!isE2E()) {
    e2eNextExportPath = null
    e2eNextImportPath = null
    return
