...
/**
 * Loads keybind snapshot from the preload bridge into the store ref, or throws on failure.
 */
export async function runFaKeybindsRefreshKeybinds (
  ...
  throw new Error(i18n.global.t('globalFunctionality.faKeybinds.loadError'))
}
