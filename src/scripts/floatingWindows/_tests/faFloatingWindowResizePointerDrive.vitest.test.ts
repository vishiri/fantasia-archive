 ...
 */
test('Test that FaFloatingWindowResizePointerSession dispose calls cancelAnimationFrame when a rAF is pending', () => {
 ...
 */
test('Test that FaFloatingWindowResizePointerSession coalesces pointermoves until the animation frame runs', () => {
  let rafCallback: FrameRequestCallback | null = null
