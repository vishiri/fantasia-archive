...
/**
 * createFaColorPickerInputPickerEmit
 * Throttles picker-driven model sync while keeping a local draft for live UI.
 */
test('createFaColorPickerInputPickerEmit throttles picker updates and flushes on change', () => {
  vi.useFakeTimers()
 ...
 */
test('createFaColorPickerInputPickerEmit flushes pending picker sync on menu hide', () => {
  vi.useFakeTimers()
 ...
 */
test('createFaColorPickerInputPickerEmit clears draft when modelValue matches emitted draft', () => {
  vi.useFakeTimers()
 ...
 */
test('createFaColorPickerInputPickerEmit cancels throttled emit on teardown', () => {
  vi.useFakeTimers()
