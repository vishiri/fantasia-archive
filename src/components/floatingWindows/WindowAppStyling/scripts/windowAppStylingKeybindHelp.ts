...
/**
 * Single help-tooltip row: an i18n key (under 'floatingWindows.appStyling.helpTooltip.items')
 * paired with the platform-resolved chord text shown next to the label.
 */
export interface I_FaMonacoKeybindHelpItem {
  /**
   * Sub-key under 'floatingWindows.appStyling.helpTooltip.items', e.g. 'commandPalette'.
...
/**
 * Builds the static list of Monaco editor keybinds shown in the WindowAppStyling help tooltip.
 *
