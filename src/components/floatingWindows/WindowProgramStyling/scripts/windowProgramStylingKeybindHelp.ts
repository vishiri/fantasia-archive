...
export interface I_FaMonacoKeybindHelpItem {
  /**
   * Sub-key under 'floatingWindows.programStyling.helpTooltip.items', e.g. 'commandPalette'.
...
/**
 * Builds the static list of Monaco editor keybinds shown in the WindowProgramStyling help tooltip.
 *
