...
test('Test that createUseProjectAppControlBarTabContextMenu delegates to session wiring', () => {
  const useTabContextMenu = createUseProjectAppControlBarTabContextMenu({
