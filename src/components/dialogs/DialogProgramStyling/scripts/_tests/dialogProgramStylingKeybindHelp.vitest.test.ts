...
import { getMonacoKeybindHelpItems } from '../dialogProgramStylingKeybindHelp'
...
/**
 * dialogProgramStylingKeybindHelp
 * The static row order and i18n label keys must match the entries the dialog renders, regardless of platform.
 */
