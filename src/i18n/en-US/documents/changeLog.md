...
- **Program settings** dialog uses **vertical category tabs** and a **scrollable** main column (**`q-tabs`** / **`q-tab-panels`** / **`q-scrollarea`**); the **title**, **tab rail**, and **Close** / **Save** actions stay fixed while long category content scrolls.
