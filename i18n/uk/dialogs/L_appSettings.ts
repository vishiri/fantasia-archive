export default {
  ...
  appOptionsCategories: {
    ...
    hierarchicalTree: {
      ...
      treeSettings: {
        subtitle: 'Налаштування дерева',
        tags: 'панель дерева, видимість бічної панелі, макет дерева',
      }
    },
    openedDocumentsTabs: {
  ...
  appOptions: {
    ...
    compactDocumentCount: {
      ...
      description: 'Показує кількість документів без додаткового номера категорії.',
    ...
    disableDocumentCounts: {
      title: 'Повністю приховати кількість документів',
      description: 'Приховує всю інформацію про кількість документів в ієрархічному дереві.',
    ...
    hideHierarchyTree: {
      title: 'Приховати ієрархічне дерево',
      description: 'Контролює, чи відображатиметься ієрархічне дерево.',
      tags: 'бічну панель вимкнено, навігатор приховано, панель дерева, контур приховати',
    },
    hidePlushes: {
    ...
    hideTreeExtraIcons: {
      title: 'Приховати додаткові значки',
      description: 'Приховує піктограми, які зазвичай відображаються для зручності, але не додають функціональності — наприклад, піктограму «Відкрити документ» поруч із документом без дочірніх вузлів, яку можна відкрити звичайним клацанням лівою кнопкою миші замість піктограми.',
      tags: 'зайві піктограми, безлад, мінімальне дерево, додаткові дії',
    },
    ...
    invertTreeSorting: {
      title: 'Інвертувати користувацький порядок сортування дерева',
      description: 'Сортує документи в ієрархічному дереві в протилежному напрямку від типового: від найвищого до найнижчого.',
      tags: 'зворотний порядок, нестандартний порядок, напрямок сортування, зростання за спаданням',
    },
    limitEditorHeight: {
    ...
    logFullActivityPayload: {
      ...
      description: 'Якщо увімкнено, активність журналюватиме повні корисні навантаження. Це може бути корисно під час глибокої відладки, коли потрібне точне журналювання результатів.',
