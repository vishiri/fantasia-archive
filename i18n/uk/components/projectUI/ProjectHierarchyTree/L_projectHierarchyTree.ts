export default {
  contextMenu: {
    ...
    copyDocument: 'Копіювати документ',
    copyOfDocumentNamePrefix: 'Копія - {originalName}',
  ...
  placementCountTooltip: {
    categoryCount: 'Кількість категорій:',
    documentCount: 'Кількість документів:',
    totalCount: 'Кількість документів і категорій:'
  },
  ...
  renameTagDialog: {
    ...
    mergeWarningTooltip: 'Another tag already uses this name (case-insensitive). Confirming merges the tags.',
    nameLabel: 'New tag name',
    title: 'Rename Tag'
  },
  tagsWrapperLabel: 'Tags'
}
