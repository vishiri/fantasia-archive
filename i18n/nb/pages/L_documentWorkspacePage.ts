export default {
  ...
  backgroundColorFieldLabel: 'Dokumentets bakgrunnsfarge',
  ...
  isCategoryDescription:
    'Denne innstillingen slår på kategorimodus for gjeldende dokument. Et dokument i kategorimodus skjuler de fleste feltene og vises ikke i andre relasjonssøk enn Tilhører under.',
  isCategoryTitle: 'Er en kategori',
  isDeadDescription:
  ...
  textColorFieldLabel: 'Dokumentets tekstfarge'
}
