export default {
  ...
  backgroundColorFieldLabel: "Couleur d'arrière-plan du document",
  ...
  isCategoryDescription:
    'Ce réglage active le mode catégorie pour le document actuel. Un document en mode catégorie masque la plupart de ses champs et n’apparaît dans aucune autre recherche de relation sauf Appartient à.',
  isCategoryTitle: 'Est une catégorie',
  isDeadDescription:
  ...
  textColorFieldLabel: 'Couleur du texte du document'
}
