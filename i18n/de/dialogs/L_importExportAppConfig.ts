export default {
  ...
  errors: {
    desktopOnly: 'Die App-Konfiguration ist nur in der Desktop-App verfügbar.',
    exportToFileFailed: 'Der Export in eine Datei ist fehlgeschlagen',
    importValidationFailed: 'Die Importvalidierung ist fehlgeschlagen'
  }
}
