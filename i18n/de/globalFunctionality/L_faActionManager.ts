export default {
  ...
  actionTimedOut: 'Aktion nach 30 Sekunden abgebrochen.',
  queueOverflow: 'Zu viele ausstehende Aktionen; diese wurde verworfen.',
  labels: {
    closeApp: 'Fenster schließen',
    languageSwitch: 'Oberflächensprache wechseln',
    minimizeApp: 'Fenster minimieren',
    openAboutFantasiaArchiveDialog: 'Über Fantasia Archive öffnen',
    openActionMonitorDialog: 'Aktionsmonitor öffnen',
    openAdvancedSearchGuideDialog: 'Leitfaden zur erweiterten Suche öffnen',
