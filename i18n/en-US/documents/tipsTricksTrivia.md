...
- Any field in document editing mode with the small dropdown arrow allows custom values! Close the menu of predefined values with Esc, type your desired value, and confirm with Enter.
- You can search through all documents and all of their fields at once using the following in either the Quick search popup or any of the relationship searches: `%field-name:whatever-you-need`
...
- Fantasia Archive is free; no strings attached: No ads, no trackers, no crypto-mining happening on your PC, and your data stays entirely yours!
- If these tips annoy you, there is a switch to turn them off in the app settings.
- Relationship search is packed to the brim with extra features you can use to find what you need! Read all about it in the `Advanced Search Guide` in the Help menu!
...
- The left hierarchical tree is expandable by dragging the divider, and the app remembers where you left it the next time you launch!
...
- Tags are a very powerful feature that allows you to add semi-categories to the project tree and create additional search parameters to aid navigation.
