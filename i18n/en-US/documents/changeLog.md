...
- **FantasiaMascotImage**: inner wrapper uses **`max-width: 100%`** so large **width** props do not overflow the viewport.
...
- **FantasiaMascotImage** uses **Quasar** **q-img** with spinner disabled; **width** and **height** props apply to **q-img**, the inner raster uses **img-class** for **user-select** parity, and the duplicate **title** mirroring **alt** was removed from the wrapper.
