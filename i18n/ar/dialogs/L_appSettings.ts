export default {
  ...
  appOptionsCategories: {
    ...
    hierarchicalTree: {
      ...
      treeSettings: {
        subtitle: 'إعدادات الشجرة',
        tags: 'لوحة الشجرة، رؤية الشريط الجانبي، تخطيط الشجرة',
      }
    },
    openedDocumentsTabs: {
    ...
    popupsFloatingWindows: {
      ...
      quickSearchDialog: {
        subtitle: 'مربع حوار البحث السريع',
        tags: 'بحث سريع، بحث لوحة المفاتيح، مكتشف',
      },
      universalDialogSettings: {
        subtitle: 'إعدادات الحوار العالمية',
        tags: 'جميع مربعات الحوار، والسلوك المنبثق العالمي',
      }
    },
    visualAccessibility: {
  ...
  appOptions: {
    ...
    compactDocumentCount: {
      ...
      description: 'يعرض عدد المستندات بدون الرقم الثانوي لكل فئة.',
    ...
    disableDocumentCounts: {
      title: 'إخفاء عدد المستندات بالكامل',
      description: 'إخفاء كافة معلومات عدد المستندات في الشجرة الهرمية.',
    ...
    doNotCollapseTreeOptions: {
      title: 'منع انهيار المستوى الفرعي في الشجرة',
      description: 'يمنع إغلاق الفئات الفرعية في الشجرة الهرمية عند إغلاق الفئة الأصلية.',
      tags: 'تذكر موسعة، متداخلة مفتوحة، الأكورديون، انهيار الأطفال',
    },
    doubleDashDocCount: {
    ...
    hideHierarchyTree: {
      title: 'إخفاء الشجرة الهرمية',
      description: 'التحكم في عرض الشجرة الهرمية.',
      tags: 'الشريط الجانبي مغلق، المتصفح مخفي، لوحة الشجرة، إخفاء المخطط التفصيلي',
    },
    hidePlushes: {
    ...
    hideTreeExtraIcons: {
      title: 'إخفاء الرموز الإضافية',
      description: 'يخفي الرموز التي يتم عرضها عادةً للملاءمة ولكنها لا تضيف وظائف - على سبيل المثال أيقونة "فتح مستند" بجوار مستند لا يحتوي على عقد فرعية، والتي يمكن فتحها أيضًا بالنقر العادي بزر الماوس الأيسر بدلاً من الرمز.',
      tags: 'أيقونات زائدة عن الحاجة، فوضى، شجرة صغيرة، إجراءات اختيارية',
    },
    ...
    invertTreeSorting: {
      title: 'عكس فرز ترتيب الشجرة المخصصة',
      description: 'فرز المستندات في الشجرة الهرمية في الاتجاه المعاكس للاتجاه الافتراضي: من الأعلى إلى الأدنى.',
      tags: 'ترتيب عكسي، ترتيب مخصص، اتجاه الفرز، تصاعدي تنازلي',
    },
    limitEditorHeight: {
    ...
    preventFilledNoteBoardPopup: {
      title: 'منع المفكرة المملوءة من الظهور',
      description: 'عند التمكين، لن يتم فتح المفكرة تلقائيًا عند بدء التطبيق عندما لا تزال تحتوي على ملاحظات من جلسات FA السابقة.',
      tags: 'الملاحظات اللاصقة، المفكرة، بدء التشغيل، الفتح التلقائي، التذكيرات',
    },
