export default {
  ...
  backgroundColorFieldLabel: 'ドキュメントの背景色',
  ...
  isCategoryDescription:
    'この設定で現在のドキュメントをカテゴリモードにできます。カテゴリモードのドキュメントはほとんどのフィールドを非表示にし、「所属先」以外の関係検索には表示されません。',
  isCategoryTitle: 'カテゴリである',
  isDeadDescription:
  ...
  textColorFieldLabel: 'ドキュメントの文字色'
}
