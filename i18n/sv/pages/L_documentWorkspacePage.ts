export default {
  ...
  isCategoryDescription:
    'Den här inställningen aktiverar kategoriläge för det aktuella dokumentet. Ett dokument i kategoriläge döljer de flesta fält och visas inte i andra relationssökningar än Tillhör under.',
  isCategoryTitle: 'Är en kategori',
  isDeadDescription:
