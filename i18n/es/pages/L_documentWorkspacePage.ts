export default {
  ...
  backgroundColorFieldLabel: 'Color de fondo del documento',
  ...
  isCategoryDescription:
    'Este ajuste activa el modo categoría del documento actual. Un documento en modo categoría oculta la mayoría de sus campos y no aparece en otras búsquedas de relaciones excepto Pertenece a.',
  isCategoryTitle: 'Es una categoría',
  isDeadDescription:
  ...
  textColorFieldLabel: 'Color de texto del documento'
}
