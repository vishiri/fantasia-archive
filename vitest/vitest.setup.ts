...
function buildVitestProjectContentApiMock (): ReturnType<typeof createFaProjectContentBridgeHarnessStub> {
  ...
  return {
    ...
    linkWorldDocumentTemplate: vi.fn(stub.linkWorldDocumentTemplate),
    ...
    listDocumentTemplatesForWorld: vi.fn(stub.listDocumentTemplatesForWorld),
    listDocuments: vi.fn(stub.listDocuments),
    listMedia: vi.fn(stub.listMedia),
    listWorlds: vi.fn(stub.listWorlds),
    listWorldsForDocumentTemplate: vi.fn(stub.listWorldsForDocumentTemplate),
    ...
    unlinkWorldDocumentTemplate: vi.fn(stub.unlinkWorldDocumentTemplate),
