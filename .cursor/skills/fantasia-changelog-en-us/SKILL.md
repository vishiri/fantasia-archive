...
- A bare **pipe** **`|`** is also special in message format; use the **vue-i18n** documented escape when you need a literal pipe in locale copy (see existing **App settings** tooltip notes in the codebase).
