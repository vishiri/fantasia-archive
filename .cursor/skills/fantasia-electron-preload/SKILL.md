...
6. Vitest: **`contentBridgeAPIs/_tests/`**, **`ipcManagement/_tests/`** — dev scoped connected specs during edits; **full** **`yarn testbatch:verify`** enforces **95%** on **`src-electron`** before commit
